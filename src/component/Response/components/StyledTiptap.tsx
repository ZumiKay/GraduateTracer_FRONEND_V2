...
const StyledTiptap: React.FC<StyledTiptapProps> = ({
  ...
  const getVariantClasses = () => {
    switch (variant) {
      case "question":
        return "text-base font-medium text-gray-900 leading-relaxed mb-3 prose prose-sm max-w-none prose-headings:text-gray-900 prose-headings:font-semibold prose-p:text-gray-700 prose-strong:text-gray-900 prose-em:text-gray-700 prose-code:text-purple-600 prose-code:bg-purple-50 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-ul:text-gray-700 prose-ol:text-gray-700";
      case "content":
        return "text-sm text-gray-600 leading-relaxed prose prose-sm max-w-none prose-headings:text-gray-800 prose-p:text-gray-600 prose-strong:text-gray-800 prose-em:text-gray-600";
      default:
        return "text-sm text-gray-700 leading-relaxed prose prose-sm max-w-none";
    }
  };
